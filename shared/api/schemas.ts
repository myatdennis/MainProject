...
const enforceLessonContentType = <T extends z.ZodTypeAny>(schema: T) =>
...
export const lessonPatchSchema = enforceLessonContentType(
  lessonSchemaObject.partial().extend({
