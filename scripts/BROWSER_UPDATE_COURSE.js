// Copy and paste this into your browser console while on the LMS page
// This bypasses the rate limiting issue
...
.then(data => {
  ...
  console.log('📺 TED Talk: Racism Has a Cost for Everyone');
  console.log('🌍 Status: Published with thumbnail and difficulty');
  console.log('\nRefresh the page to see the course card!');
  console.log(data);
})
.catch(err => {
