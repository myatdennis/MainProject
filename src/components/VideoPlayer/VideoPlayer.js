...
export default function VideoPlayer({ src, userId, lessonId, captions = [], className, onComplete }) {
    ...
    if (isEmbedded) {
        ...
        return (_jsx("div", { className: className, style: { position: 'relative', paddingTop: '56.25%' }, children: _jsx("iframe", { src: src, title: "Embedded video", style: { position: 'absolute', top: 0, left: 0, width: '100%', height: '100%' }, frameBorder: 0, allow: "accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture", allowFullScreen: true }) }));
    }
    return (_jsx("div", { className: className, children: _jsxs("video", { ref: videoRef, controls: true, style: { width: '100%', height: 'auto', background: '#000' }, children: [captions.map((t, i) => (_jsx("track", { src: t.src, kind: "subtitles", srcLang: t.srclang, label: t.label, default: t.default }, i))), "Sorry, your browser does not support embedded videos."] }) }));
}
